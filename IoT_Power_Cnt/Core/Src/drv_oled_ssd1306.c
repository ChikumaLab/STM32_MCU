...
void drv_oled_ssd1306_set_solar_param(float data)
{
	char string[32];
	uint8_t len ;
...
void drv_oled_ssd1306_set_main_param(float data)
{
	char string[32];
	uint8_t len ;
...
void drv_oled_ssd1306_set_edlc_param(float data)
{
	char string[32];
	uint8_t len ;
